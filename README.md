...
This is PHP version of [The Supermarket Receipt Refactoring Kata](https://github.com/emilybache/SupermarketReceipt-Refactoring-Kata), which is a variation of a popular kata described in http://codekata.com/kata/kata01-supermarket-pricing/. The aim of the exercise is to build automated tests for this code, refactor it, and add a new feature.
...
I've presented refactoring and implementation of first feature in [my YouTube channel](https://youtu.be/76V5qh_gc_c) and you can find the result in the [bundles-solution branch](https://github.com/koding-dojo/supermarket-refactoring/tree/bundles-solution).